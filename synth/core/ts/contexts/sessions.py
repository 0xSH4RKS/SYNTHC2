...
from synth.core.events import Events
from synth.core.utils import gen_random_string, CmdError
from synth.core.ts import ipc_server
from synth.core.ts.db import STDatabase
from synth.core.ts.crypto import gen_stager_psk
from synth.core.ts.session import Session, SessionNotFoundError
from synth.core.ts.job import Job
from time import gmtime, strftime
#from core.ts.utils import subscribe, register_subscriptions
    ...
    def get_session(self, guid, attempt_auto_reg=True):
        try:
            ...
            if attempt_auto_reg:
                ...
                logging.warning(colored("This could be an orphaned session or somebody could be messing with the ts!", "red"))
